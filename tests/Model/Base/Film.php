 ...
 * @codeCoverageIgnore
 */
abstract class ORMTest_Model_Base_Film extends ORMTest_Model_Base_Record
{
    const TABLE_NAME = 'film';

    const MODEL_NAME = 'ORMTest_Model_Film';
    ...
    {
        $this->hasRelation('FilmActor', new ORM_Relation_One2Many('ORMTest_Model_FilmActor', 'film_id', 'film_id'));
        $this->hasRelation('FilmCategory', new ORM_Relation_One2Many('ORMTest_Model_FilmCategory', 'film_id', 'film_id'));
        $this->hasRelation('Inventory', new ORM_Relation_One2Many('ORMTest_Model_Inventory', 'film_id', 'film_id'));
        $this->hasRelation('Language', new ORM_Relation_One2One('ORMTest_Model_Language', 'original_language_id',  'language_id'));
    }
